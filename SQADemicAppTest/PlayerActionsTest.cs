...
namespace SQADemicAppTest
{
    ...
    public class PlayerActionsTest
    {
        ...
        Cards _chennai, _newYork, _atlanta, _chicagoCard, _london, _paris, _milan, _airlift;
        ...
        public void SetupPlayer()
        {
            ...
            _chennai = new CityCard("Chennai", Color.Black);
            _newYork = new CityCard("New York", Color.Blue);
            _atlanta = new CityCard("Atlanta", Color.Blue);
            _chicagoCard = new CityCard("Chicago", Color.Blue);
            _paris = new CityCard("Paris", Color.Blue);
            _london = new CityCard("London", Color.Blue);
            _milan = new CityCard("Milan", Color.Blue);
            _airlift = new SpecialCard("Airlift");
        ...
        public void TestDirectFlightCurrentCityChicago()
        {
            ...
            _scientist.Hand = new List<Cards> { _chicagoCard };
            List<string> returnList = _scientist.DirectFlightOption();
            List<string> correctList = new List<string>();
            CollectionAssert.AreEqual(correctList, returnList);
        }
        ...
        {
            _scientist.CurrentCity = _chicagoCity;
            _scientist.Hand = new List<Cards> { _chicagoCard, _atlanta, _chennai };
            List<string> returnList = _scientist.DirectFlightOption();
        ...
        {
            _scientist.CurrentCity = _chicagoCity;
            _scientist.Hand = new List<Cards> { _airlift, _atlanta, _chennai };
            List<string> returnList = _scientist.DirectFlightOption();
            List<string> correctList = new List<string> { _atlanta.CityName, _chennai.CityName };
            CollectionAssert.AreEqual(correctList, returnList);
        ...
        {
            _hand = new List<Cards> { _airlift, _atlanta, _chennai };
            _scientist.Hand = _hand;
            _scientist.CurrentCity = _chicagoCity;
        ...
        {
            _hand = new List<Cards> { _airlift, _atlanta, _chicagoCard };
            _scientist.Hand = _hand;
            _scientist.CurrentCity = _chicagoCity;
            bool returendBool = _scientist.CharterFlightOption();
        ...
        {
            _scientist.CurrentCity = _chicagoCity;
            _hand = new List<Cards> { _airlift, _chicagoCard, _chennai };
            _scientist.Hand = _hand;
        ...
        public void TestMoverPlayerAdjacentCityChicagoWithCard()
        {
            ...
            _hand = new List<Cards> { _airlift, _chicagoCard, _chennai };
            List<Cards> correctHand = new List<Cards> { _airlift, _chicagoCard, _chennai };
            _scientist.Hand = _hand;
        ...
        public void TestMoverPlayerDirectFlight()
        {
            ...
            _hand = new List<Cards> { _airlift, _chicagoCard, _chennai, _atlanta };
            _pile = new List<Cards>();
            _scientist.Hand = _hand;
            _scientist.Move(_chicagoCity);
            List<Cards> correctHand = new List<Cards> { _airlift, _chennai, _atlanta };
            Assert.AreEqual(_scientist.CurrentCity.Name, _chicagoCity.Name);
            CollectionAssert.AreEqual(correctHand, _hand);
        }
        ...
        public void TestMoverPlayerCharterFlight()
        {
            ...
            List<Cards> correctHand = new List<Cards> { _airlift, _chennai };
        ...
        public void TestMoverPlayerShuttleFlightPreemptCard()
        {
            ...
            _bangkok.ResearchStation = true;
            _scientist.CurrentCity = _chicagoCity;
            _hand = new List<Cards> { _airlift, _atlanta, _chennai, _chicagoCard };
            _pile = new List<Cards>();
            _scientist.Hand = _hand;
            Assert.AreEqual(true, _scientist.Move(_bangkok));
            List<Cards> correctHand = new List<Cards> { _airlift, _atlanta, _chennai, _chicagoCard };
            Assert.AreEqual(_scientist.CurrentCity.Name, _bangkok.Name);
            CollectionAssert.AreEqual(correctHand, _hand);
            _chicagoCity.ResearchStation = false;
            _bangkok.ResearchStation = false;
        ...
        public void TestMoverPlayerInvalid()
        {
            ...
            List<Cards> correctHand = new List<Cards> { _airlift, _atlanta, _chennai };
            Assert.AreEqual(_scientist.CurrentCity.Name, _chicagoCity.Name);
            CollectionAssert.AreEqual(correctHand, _hand);
        }
        ...
        {
            _scientist.CurrentCity = _chicagoCity;
            _hand = new List<Cards> { _airlift, _chennai };
            _scientist.Hand = _hand;
            List<Cards> correctHand = new List<Cards> { _airlift, _chennai };
        ...
        {
            _hand = new List<Cards> { _chennai, _newYork, _atlanta, _chicagoCard, _london, _paris, _airlift };
            _opExpert.Hand = _hand;
            ...
            List<Cards> correctHand = new List<Cards> { _chennai, _airlift };
            _opExpert.CurrentCity = _chicagoCity;
            _chicagoCity.ResearchStation = true;
        ...
        {
            _hand = new List<Cards> { _newYork, _chennai, _atlanta, _chicagoCard, _airlift };
            _opExpert.Hand = _hand;
            _opExpert.CurrentCity = _chicagoCity;
            _chicagoCity.ResearchStation = true;
            List<string> cardsToSpend = new List<string> { _newYork.CityName, _chicagoCard.CityName };
            List<Cards> correctHand = new List<Cards> { _newYork, _chennai, _atlanta, _chicagoCard, _airlift };
        ...
        {
            _hand = new List<Cards> { _chennai, _newYork, _atlanta, _chicagoCard, _london, _paris, _milan, _airlift };
            _opExpert.Hand = _hand;
            ...
            List<Cards> correctHand = new List<Cards> { _chennai, _newYork, _atlanta, _chicagoCard, _london, _paris, _milan, _airlift };
            _opExpert.CurrentCity = _chicagoCity;
            _chicagoCity.ResearchStation = true;
            Assert.AreEqual(false, _opExpert.Cure(cardsToSpend, Color.Blue));
            CollectionAssert.AreEqual(correctHand, _hand);
        ...
        public void TestCureInvalidCards()
        {
            ...
            List<Cards> correctHand = new List<Cards> { _chennai, _newYork, _atlanta, _chicagoCard, _london, _paris, _airlift };
            _opExpert.CurrentCity = _chicagoCity;
            _chicagoCity.ResearchStation = true;
            Assert.AreEqual(false, _opExpert.Cure(cardsToSpend, Color.Blue));
            CollectionAssert.AreEqual(correctHand, _hand);
        ...
        public void TestCureSimpleScientist()
        {
            ...
            List<Cards> correctHand = new List<Cards> { _chennai, _paris, _airlift };
            _scientist.CurrentCity = _chicagoCity;
            _chicagoCity.ResearchStation = true;
        ...
        {
            List<Cards> hand1 = new List<Cards> { _chennai, _newYork, _chicagoCard };
            List<Cards> hand2 = new List<Cards> { _atlanta, _london };
            _scientist.Hand = new List<Cards> { _chennai, _newYork };
            _opExpert.Hand = new List<Cards> { _atlanta, _london, _chicagoCard };
            _scientist.CurrentCity = _chicagoCity;
            _opExpert.CurrentCity = _chicagoCity;
        ...
        {
            List<Cards> hand1 = new List<Cards> { _chennai, _newYork };
            List<Cards> hand2 = new List<Cards> { _atlanta, _london, _chicagoCard };
            _scientist.Hand = new List<Cards> { _chennai, _newYork };
            _opExpert.Hand = new List<Cards> { _atlanta, _london, _chicagoCard };
            _scientist.CurrentCity = _chicagoCity;
        ...
        public void TestShareChicagoinBangkokResearcherPass()
        {
            ...
            List<Cards> hand2 = new List<Cards> { _atlanta, _london };
            _scientist.Hand = new List<Cards> { _chennai, _newYork };
            _researcher.Hand = new List<Cards> { _atlanta, _london, _chicagoCard };
            _scientist.CurrentCity = _bangkok;
        ...
        public void TestShareChicagoMissingCardFail()
        {
            ...
            List<Cards> hand2 = new List<Cards> { _atlanta, _london };
            _scientist.Hand = new List<Cards> { _chennai, _newYork };
            _opExpert.Hand = new List<Cards> { _atlanta, _london };
            _scientist.CurrentCity = _chicagoCity;
            _opExpert.CurrentCity = _chicagoCity;
            Assert.AreEqual(false, _opExpert.ShareKnowledgeOption(_scientist, _chicagoCard.CityName));
            CollectionAssert.AreEqual(_scientist.Hand, hand1);
        ...
        public void TestWinCon()
        {
            ...
            _scientist.Hand = new List<Cards> { _atlanta, _chicagoCard, _london, _paris };
